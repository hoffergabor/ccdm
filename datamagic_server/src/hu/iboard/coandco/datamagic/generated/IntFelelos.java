...
/**
 * IntFelelos generated by hbm2java
 */
@Entity
@Table(name = "INTFELELOS")//, catalog = "dms")
public class IntFelelos implements java.io.Serializable {
	...
	public IntFelelos(int id) {
		this.id = id;
	}

	public IntFelelos(int id, String x, String nev, String irsz, String varos,
