							...
							<fo:table-body>
								<xsl:for-each select="list/main">
									...
									<fo:table-row>
										...
										<fo:table-cell padding-top="3pt" border-right="solid 0.03cm black">
											<fo:block margin-left="3pt">
												<xsl:value-of select="./sirsz" />
												<xsl:text> </xsl:text>
												<xsl:value-of select="./svaros" />
												<xsl:text> </xsl:text>
												<xsl:value-of select="./scim" />
												<xsl:text> </xsl:text>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding-top="3pt">
									...
									<fo:table-row>
										...
										<fo:table-cell padding-top="3pt">
											<fo:block margin-left="3pt">
												<xsl:text>azonosító</xsl:text>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding-top="3pt">
											<fo:block margin-left="3pt">
												<xsl:value-of select="./azon" />
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row>
										...
										<fo:table-cell padding-top="3pt" border-right="solid 0.03cm black">
											<fo:block margin-left="3pt">
												<xsl:value-of select="./kozadoszam" />
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding-top="3pt">
											<fo:block margin-left="3pt">
												<xsl:text>raktár</xsl:text>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding-top="3pt">
											<fo:block margin-left="3pt">
												<xsl:value-of select="./raktar" />
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row>
									...
									<fo:table-row>
										...
										<fo:table-cell padding-top="3pt">
											<fo:block margin-left="3pt">
												<xsl:text>átvétel helye</xsl:text>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding-top="3pt">
											<fo:block margin-left="3pt">
												<xsl:value-of select="./atvhely" />
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row>
								...
								<fo:table-row background-color="black">
									...
									<fo:table-cell padding-bottom="6pt" padding-top="6pt">
										<fo:block text-align="right">
											<fo:inline color="white">száll. határidő</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-header>
