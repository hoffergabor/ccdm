...
import hu.iboard.coandco.datamagic.presentation.controllers.prprojekt.PRProjektController;
...
public class DataMagicFunctionMap {
	...
	static {
		...
		pageNameToFunctionClassName.put(PRProjektController.PRPROJEKT_ACTION,"prProjektController");
