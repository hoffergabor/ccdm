...
public class OrderControllerData implements Serializable {
	...
	private Integer shippingOption = 1;
	...
	private Integer shippingArukod;
	...
	public Integer getShippingArukod() {
		return shippingArukod;
	}

	public void setShippingArukod(Integer shippingArukod) {
		this.shippingArukod = shippingArukod;
	}
