...
public class OpenItemsServiceController extends AbstractController {
	...
	public void loadData() {
		...
		getData().setOpenItemList(getInvoiceService().getOpenItemList(getData().getVevokod(), null, null));
		initSummary();
	...
	public void invoiceDateChange(ActionEvent event) {
		...
		getData().setOpenItemList(getInvoiceService().getOpenItemList(getData().getVevokod(), getData().getFrom(), getData().getTo()));
		initSummary();
	}
