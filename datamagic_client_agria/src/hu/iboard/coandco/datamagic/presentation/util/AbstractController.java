...
public abstract class AbstractController extends AbstractBaseDatabase {
	...
	public Partner getManagedStore() {

		return getLoginManager().getData().getLoggedInStore();

	}

	public List<Partner> getManagedStores() {

		return getLoginManager().getData().getStores();

	}

	public List<Date> getManagedFuvDates() {

		return getLoginManager().getData().getFuvDates();

	}

	public void setManagedFuvDates(List<Date> dates) {
		getLoginManager().getData().setFuvDates(dates);
	}
	...
	public String getDayByDate(Date date) {
		switch (date.getDay()) {
		case 0:
			return "Vasárnap";
		case 1:
	...
	@SuppressWarnings("deprecation")
	public String convertDateTimeTosString(Date date) {

		String dateFromYear = Integer.valueOf(1900 + date.getYear()).toString();
		String dateFromMonth = Integer.valueOf(1 + date.getMonth()).toString();
		String dateHour = Integer.valueOf(date.getHours()).toString();
		String dateMin = Integer.valueOf(date.getMinutes()).toString();
		...
		String convertedDate = dateFromYear + "-" + dateFromMonth + "-" + dateFromDay + " " + dateHour + ":" + dateMin;
