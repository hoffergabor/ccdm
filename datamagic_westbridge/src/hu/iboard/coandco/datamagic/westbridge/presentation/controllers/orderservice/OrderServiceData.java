package hu.iboard.coandco.datamagic.westbridge.presentation.controllers.orderservice;
...
public class OrderServiceData implements Serializable {
	...
	private List<Partner> storePartner;
	...
	public List<Partner> getStorePartner() {
		return storePartner;
	}

	public void setStorePartner(List<Partner> storePartner) {
