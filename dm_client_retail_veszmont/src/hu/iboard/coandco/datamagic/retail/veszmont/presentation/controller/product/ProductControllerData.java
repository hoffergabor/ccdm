...
public class ProductControllerData implements Serializable {
	...
	public Integer getRequestArukod() {
		return requestArukod;
	}

	public void setRequestArukod(Integer requestArukod) {
		this.requestArukod = requestArukod;
	}
